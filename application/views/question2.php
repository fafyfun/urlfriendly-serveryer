...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">How do you primarily browse Internet?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Personal">Personal Computer/Laptop
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Office">Office Computer/Laptop
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Mob">Mobile Phone
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Tab">Tablet/iPad
        </div>
...
<script>
    ...
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>question3/" + ans1 + "/"+value;
        }
