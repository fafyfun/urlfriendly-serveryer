...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">Are you using a monthly data package</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Package">Yes, I am using a data package
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="payg">No, I don't have a data package activated
        </div>
        <div id="error"></div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>question9/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+ans6+"/"+value ;
        }
