...
<div class="container">
    ...
    <div id="content">
        ...
        <div style="float: left; width: 50%;">
            <div id="result" class="alert alert-success" style="width: 75%; margin:30px auto; max-width: 250px; text-align: center; display: none " ><b>Thank you</b> for participating in our <b>survey</b>, you are now entitled for the draw to WIN an iPhone 5 and many more goodies!</div>
        </div>
...
<script>
    function validate_form(){
        ...
        if(error==1){
            $('#error').html("Please Enter Name and Phone");
            return false
        }
        else{
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>saverecord/saver",
                data:"num=" + num+"&name="+name +"&email="+email + "&ans1=" + ans1 +"&ans2="+ans2 + "&ans3=" + ans3 +"&ans4="+ans4 + "&ans5=" + ans5+"&ans6=" + ans6,
