...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">Have you used GPRS/WAP/3G/Internet through your mobile</h4>
        <div class="radio">
            <input type="radio" name="internet" value="3G">Yes
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="2G">No
        </div>
        <div id="error"></div>
...
<script>
    function validate_form(){
        ...
        if(value=="3G"){
            window.location ="<?php echo base_url(); ?>question6/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+value;
        }else if(value=="2G"){
            window.location ="<?php echo base_url(); ?>question8/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+value ;
        }
        }
