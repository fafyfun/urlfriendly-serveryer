...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">மொபைல் ஊடாக GPRS/WAP/3G/Internet  வசதியை பயன்படுத்தியுள்ளீர்களா?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="3G">ஆம்
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="2G">இல்லை
...
<script>
    function validate_form(){
        ...
        if(value=="3G"){
            window.location ="<?php echo base_url(); ?>tam/question7/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+ans5 +"/"+value;
        }else if(value=="2G"){
            window.location ="<?php echo base_url(); ?>tam/question10/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+ans5 +"/"+value ;
        }
        }
