...
<div id="header">
    ...
    <div style="width:229px; margin:0 auto;">
        <div style="position:absolute; margin-top:21px;"><img src="<?php echo base_url();?>css/images/tit_tam.jpg" width="229" height="15" alt="Mobile  internet  Survey" /></div>
    </div>
...
<div class="container">
    ...
    <div id="content">
        ...
        <form action="" method="post" class="form-inline">
            <h4 class="form-signin-heading">மொபைல் இன்டநெட் / டேட்டாவிற்காக மாதாந்தம் செலவழிக்கும் தொகை?</h4>
            <div class="radio">
                <input type="radio" name="internet" value="Less50">ரூ. 50 இற்கு குறைவு

            </div>

            <div class="radio">
                <input type="radio" name="internet" value="Less100">ரூ. 50 - ரூ.100 வரை

            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less200">ரூ. 100 - ரூ.200 வரை

            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less300">ரூ. 200 - ரூ.300 வரை

            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less500">ரூ. 300 - ரூ.500 வரை

            </div>
            <div class="radio">
                <input type="radio" name="internet" value="More500">ரூ.500 க்கு மேல்
...
<script>
    function validate_form(){
        ...
        if(value==null){
            $('#error').html("தயவு செய்து தீர்வொன்றை தெரிவு செய்யுங்கள்");
        }else{
        window.location ="<?php echo base_url(); ?>tam/newuserdetails/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+ans6+"/"+ans7+"/"+ans8+"/"+value ;
        }
