...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">ஆரம்பத்தில் இன்டநெட்டிற்கு செல்ல பயன்படுத்தியது?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Personal">சொந்த கணனி / லப்டொப்
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Office">அலுவலக கணனி / லப்டொப்
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Mob">மொபைல் போன்
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Tab">டெப்லட் / ஐபாட்
...
<script>
    ...
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>tam/question3/" + ans1 + "/"+value;
        }
