...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">மொபைல் ஊடாக செய்தி இணையத்தளங்கள் அல்லது செய்தி அப்கள் பார்வையிடும் கால இடைவெளி என்ன?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="mnce">ஒரு நாளைக்கு ஒன்றுக்கு மேற்பட்ட தடவை
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="once">ஒரு நாளைக்கு ஒரு முறை

        </div>
        <div class="radio">
            <input type="radio" name="internet" value="often">அடிக்கடி

        </div>
        <div class="radio">
            <input type="radio" name="internet" value="never">எப்போதுமில்லை
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>tam/question8/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 + "/" +ans6 +"/"+value ;
        }
