...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">நீங்கள் மாதாந்த டேட்டா பெக்கேஜ் பயன்படுத்துபவரா?
        </h4>
        <div class="radio">
            <input type="radio" name="internet" value="Package">ஆம். நான் டேட்டா பெக்கேஜை பயன்படுத்துகிறேன்.
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="payg">இல்லை. என்னிடம் டேட்டா பெக்கஜ் இல்லை
        </div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>tam/question9/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+ans6+"/"+ans7+"/"+value ;
        }
