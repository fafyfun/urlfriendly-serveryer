...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">மொபைல் ஊடாக இன்டநெட் / GPRS பயன்படுத்தாதற்கு காரணம் என்ன?
        </h4>
        <div class="radio">
            <input type="radio" name="internet" value="cmpbl">என்னிடம் பொருத்தமான மொபைல் போன் இல்லை
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="need">எனக்கு மொபைல் இன்டநெட் பயன்படுத்த வேண்டிய தேவையில்லை

        </div>

        <div class="radio">
            <input type="radio" name="internet" value="expens">செலவு கூடியது
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>tam/userdetails/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/" +ans6 +"/"+value ;
        }
