...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">உங்கள் முதல் மொபைல் இணைப்பு எது?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Airtel">எயார்டெல்
        </div>
        <div class="radio">
            <input type="radio" name="internet"  value="Dialog">டயலொக்

        </div>
        <div class="radio">
            <input type="radio" name="internet" value="Etisalat">எடிசலாட்
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="Hutch"> ஹச்
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Mobitel">மொபிடெல்
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>tam/question4/" + ans1 + "/"+ans2+ "/" +value ;
        }
