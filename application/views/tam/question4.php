...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">நீங்கள் பயன்படுத்தும் இணைப்பு எது?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="post">பிற்கொடுப்பனவு

        </div>

        <div class="radio">
            <input type="radio" name="internet" value="pre">முற்கொடுப்பனவு
...
<script>
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>tam/question5/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+value ;
        }
    }
