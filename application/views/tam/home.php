...
<div class="container">
    ...
    <div id="content">
        ...
        <form action="" method="post" class="form-inline">
            <h4 class="form-signin-heading"> உங்கள் முதல் இன்டநெட் இணைப்பு எது?</h4>
            <div class="radio">
                <input type="radio" name="internet" value="AB"> எயார்டெல்
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="DB"> டயலொக்
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="EB"> எடிசலாட்

            </div>
            <div class="radio">
                <input type="radio" name="internet" value="HB"> ஹச்

            </div>
            <div class="radio">
                <input type="radio" name="internet" value="MB"> மொபிடெல்
            </div>
            <div class="radio">
                <input type="radio" name="internet"  value="SLT">ஸ்ரீ லங்கா ரெலிகொம்  ADSL
            </div>

            <div class="radio">
                <input type="radio" name="internet" value="OT"> வேறு
...
<script>
    ...
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>tam/question2/" + value;
        }
