...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">நீங்கள் தற்போது பயன்படுத்தும் மொபைல் வகை எது?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Smart">ஸ்மார்ட் போன் (அன்ட்ரொய்ட், அப்பள், பிளக்பெரி, விண்டோஸ்)
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Normal">பீச்சர் போன் (Nokia 6600, Sony W800)
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Basic">சாதாரண போன் (Nokia 3310, Sony Erickson T10
            )
        </div>
...
<script>
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>tam/question6/" + ans1 + "/"+ans2+ "/" +ans3 +"/" +ans4 +"/"+value ;
        }
    }
