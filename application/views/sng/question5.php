...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">ඔබගේ වර්තමානයේ භාවිතා කරන දුරකථනයේ වර්ගය/මාදිලිය?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Smart">ස්මාර්ට් දුරකථන (ඇන්ඩ්‍රොයිඞ්, ඇපල්, බ්ලැක්බෙරි, වින්ඩෝස් )
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Normal">සාමාන්‍ය/විශේෂාංග සහිත දුරකථනයක් (Nokia 6600, Sony W800)
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Basic">ප‍්‍රාථමික දුරකථනයක්(Nokia 3310,Sony Erickson T10)
        </div>
...
<script>
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>sng/question6/" + ans1 + "/"+ans2+ "/" +ans3 +"/" +ans4 +"/"+value ;
        }
    }
