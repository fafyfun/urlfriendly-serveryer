...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">ඔබේ දුරකථනය හරහා ඔබ කීවරක් ප‍්‍රවෘත්ති වෙබ්අඩවිවලට/නිව්ස් ඇප්ස්වලට පිවිසෙනවාද?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="mnce">දවසට කීපවතාවක්
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="once">දිනකට එක්වරක්
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="often">සෑමවිටම
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="never">කවදාවත් නෑ
        </div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>sng/question8/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 + "/" +ans6 +"/"+value ;
        }
