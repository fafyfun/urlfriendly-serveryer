...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">ඔබ භාවිතා කරන්නේ මාසික ඬේටා පැකේජයද?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Package">ඔව්, මම භාවිතා කරන්නේ මාසික ඬේටා පැකේජයයි
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="payg">නෑ. මම ඬේටා පැකේජයක් භාවිතා කරන්නෑ
        </div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>sng/question9/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+ans6+"/"+ans7+"/"+value ;
        }
