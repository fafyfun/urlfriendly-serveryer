...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">අන්තර්ජාල සමබන්ධතාවක් භාවිතා නොකිරීමට /දුරකථනය හරහා GPRS භාවිතා නොකිරීමට හේතුව කුමක්ද?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="cmpbl">මගේ දුරකථනය සඳහා අන්තර්ජාලය භාවිතා කිරීමේ පහසුකම නැත
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="need">මට දුරකථනය හරහා අන්තර්ජාලය වෙත පිවිසීමට අවශ්‍ය නැත
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="expens">එය මිලෙන් අධිකයි
        </div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>sng/userdetails/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/" +ans6 +"/"+value ;
        }
