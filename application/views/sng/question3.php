...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">ඔබ භාවිතා කරන ප‍්‍රධාන ජංගම දුරකථන සම්බන්ධතාව කුමක්ද?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Airtel">එයාර්ටෙල්
        </div>
        <div class="radio">
            <input type="radio" name="internet"  value="Dialog">ඩයලොග්
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="Etisalat">එටිසලාට්
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="Hutch">හච්
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Mobitel">මොබිටෙල්
        </div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>sng/question4/" + ans1 + "/"+ans2+ "/" +value ;
        }
