...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">ඔබ ජංගම දුරකථනය හරහා GPRS/WAP/3G/ භාවිතා කර තිබේද?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="3G">ඔව්
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="2G">නැත
        </div>
...
<script>
    function validate_form(){
        ...
        if(value=="3G"){
            window.location ="<?php echo base_url(); ?>sng/question7/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+ans5 +"/"+value;
        }else if(value=="2G"){
            window.location ="<?php echo base_url(); ?>sng/question10/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+ans5 +"/"+value ;
        }
        }
