...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">ඔබේ අන්තර්ජාල සම්බන්ධතාවට සම්බන්ධවන්නේ කෙසේද?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Personal">පුද්ගලික පරිගණකය හරහා/ලැප්ටොප්
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Office">කාර්යාලයීය පරිගණකය හරහා
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Mob">ජංගම දුරකථන
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Tab">ටැබ්ලට්/අයි පෑඞ්
        </div>
...
<script>
    ...
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>sng/question3/" + ans1 + "/"+value;
        }
