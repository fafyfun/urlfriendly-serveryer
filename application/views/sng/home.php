...
<div class="container">
    ...
    <div id="content">
        ...
        <form action="" method="post" class="form-inline">
            <h4 class="form-signin-heading">ඔබ භාවිතා කරන ප‍්‍රධාන අන්තර්ජාල සම්බන්ධතාව කුමක්ද?</h4>
            <div class="radio">
                <input type="radio" name="internet" value="AB"> එයාර්ටෙල් බ්‍රෝඞ්බෑන්ඞ්
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="DB"> ඩයලොග් බ්‍රෝඞ්බෑන්ඞ්
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="EB"> එටිසලාට් බ්‍රෝඞ්බෑන්ඞ්
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="HB"> හච් බ්‍රෝඞ්බෑන්ඞ්
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="MB"> මොබිටෙල් බ්‍රෝඞ්බෑන්ඞ්
            </div>
            <div class="radio">
            ...
            <div class="radio">
                <input type="radio" name="internet" value="OT"> වෙනත්
            </div>
...
<script>
    ...
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>sng/question2/" + value;
        }
