...
<div class="container">
    ...
    <div id="content">
        ...
        <form action="" method="post" class="form-inline">
            <h4 class="form-signin-heading">ඔබ විසින් දුරකථන අන්තර්ජාල සම්බන්ධතාව සඳහා කොපමණ වැයකරන්නේද?</h4>
            <div class="radio">
                <input type="radio" name="internet" value="Less50">රු.50ට අඩුවෙන්
            </div>

            <div class="radio">
                <input type="radio" name="internet" value="Less100">රු.50- 100ත් අතර
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less200">රු.100-200ත් අතර
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less300">රු.200-300ත් අතර
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less500">රු.300-500ත් අතර
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="More500">රු.500ට වැඩි
            </div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>sng/newuserdetails/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+ans6+"/"+ans7+"/"+ans8+"/"+value ;
        }
