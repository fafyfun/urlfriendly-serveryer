...
<div class="container">
    ...
    <div id="content">
        ...
        <form action="" method="post" class="form-inline">
            <h4 class="form-signin-heading">How much do you spend for your mobile internet/data per month?</h4>
            <div class="radio">
                <input type="radio" name="internet" value="Less50">Less than Rs.50
            </div>

            <div class="radio">
                <input type="radio" name="internet" value="Less100">Rs. 50 – Rs. 100
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less200">Rs. 100 – Rs. 200
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less300">Rs. 200 – Rs. 300
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="Less500">Rs. 300 – Rs.500
            </div>
            <div class="radio">
                <input type="radio" name="internet" value="More500">Above Rs.500
            </div>
            <div id="error"></div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>newuserdetails/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+ans6+"/"+ans7+"/"+value ;
        }
