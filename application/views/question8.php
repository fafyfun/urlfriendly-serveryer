...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">What is the reason for not using Internet/GPRS through Mobile?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="cmpbl">My Phone is not compatible
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="need">I don’t have a need to use Mobile Internet
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="expens">It’s Expensive
        </div>
        <div id="error"></div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>userdetails/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+value ;
        }
