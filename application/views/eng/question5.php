...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">What is your current Mobile Phone range/model?</h4>
        <div class="radio">
...
<script>
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>eng/question6/" + ans1 + "/"+ans2+ "/" +ans3 +"/" +ans4 +"/"+value ;
        }
    }
