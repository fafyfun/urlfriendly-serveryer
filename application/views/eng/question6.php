...
<script>
    function validate_form(){
        ...
        if(value=="3G"){
            window.location ="<?php echo base_url(); ?>eng/question7/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+ans5 +"/"+value;
        }else if(value=="2G"){
            window.location ="<?php echo base_url(); ?>eng/question10/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4 +"/"+ans5 +"/"+value ;
        }
        }
    }
