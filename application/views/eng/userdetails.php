        ...
        <div style="float: left; width: 50%;">
            <form action="" method="post" class="form-inline">
                ...
                <div style=" width:80px;">
                    <div><a href="#"><img src="<?php echo base_url();?>css/images/submit_btn.png" onClick="validate_form(); return false" alt="NEXT" width="80" height="36" border="0" /></a></div>
                </div>
    ...
    function validate_form(){
        ...
        if(error==1){
            ...
            $.ajax({
                ...
                data:"num=" + num+"&name="+name +"&email="+email + "&ans1=" + ans1 +"&ans2="+ans2 + "&ans3=" + ans3 +"&ans4="+ans4 + "&ans5=" + ans5+"&ans6=" + ans6+"&ans7=" + ans7+"&lng=" + lng,
