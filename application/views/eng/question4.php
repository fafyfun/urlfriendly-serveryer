...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">Are you on a Prepaid or a Postpaid Connection?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="post">Post Pay Connection
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="pre">Pre Paid Connection
        </div>
...
<script>
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>eng/question5/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+value ;
        }
    }
