...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">How regularly do you visit News websites / News Apps from your mobile?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="mnce">More than once a day
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="once">Once a day
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="often">Often
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="never">Never
        </div>
        <div id="error"></div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>question7/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+ans4+ "/" +ans5 +"/"+value ;
        }
