...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">What is your primary mobile connection?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Airtel">Airtel
        </div>
        <div class="radio">
            <input type="radio" name="internet"  value="Dialog">Dialog
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="Etisalat">Etisalat
        </div>
        <div class="radio">
            <input type="radio" name="internet" value="Hutch">Hutch
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Mobitel">Mobitel
        </div>
...
<script>
    function validate_form(){
        ...
        window.location ="<?php echo base_url(); ?>question4/" + ans1 + "/"+ans2+ "/" +value ;
        }
