...
<div class="container">
    ...
    <form action="" method="post" class="form-inline">
        <h4 class="form-signin-heading">What is your Mobile Phone range/model ?</h4>
        <div class="radio">
            <input type="radio" name="internet" value="Smart">Smart Phone (Android,Apple,Blackberry,Windows)
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Normal">Normal Phone (With 3G or GPRS Access)
        </div>

        <div class="radio">
            <input type="radio" name="internet" value="Basic">Basic Phone (No 3G/GPRS, e.g Nokia 3310)
        </div>
        <div id="error"></div>
...
<script>
    function validate_form(){
        ...
        if(value==null){
            ...
            window.location ="<?php echo base_url(); ?>question5/" + ans1 + "/"+ans2+ "/" +ans3 +"/"+value ;
        }
